...
// @ts-ignore
import type { NumberGreeting } from './number-greeting';
// May contain unused imports in some cases
// @ts-ignore
import type { NumberMenuOptionsInner } from './number-menu-options-inner';
// May contain unused imports in some cases
// @ts-ignore
import type { NumberTimersInner } from './number-timers-inner';
...
export interface Number {
  ...
  cid?: string;
  /**
   * Whether number uses campaign settings
   */
  uses_campaign_settings?: boolean;
  greeting?: NumberGreeting;
  timers?: Array<NumberTimersInner>;
  menu_options?: Array<NumberMenuOptionsInner>;
  created_at?: string;
  updated_at?: string;
}
