...
// @ts-ignore
import type { NumberMenuOptionsInnerMenuOption } from './number-menu-options-inner-menu-option';

export interface NumberMenuOptionsInner {
  menu_option?: NumberMenuOptionsInnerMenuOption;
}
