...
// @ts-ignore
import type { TargetCreateRequestTargetBusinessHoursAttributesInner } from './target-create-request-target-business-hours-attributes-inner';

export interface TargetCreateRequestTarget {
  /**
   * Phone number (E.164) or SIP endpoint (required)
   */
  number: string;
  name?: string;
  tid?: string;
  ...
  sip_username?: string;
  sip_password?: string;
  business_hours_attributes?: Array<TargetCreateRequestTargetBusinessHoursAttributesInner>;
}
