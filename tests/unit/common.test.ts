...
describe('Common Utilities', () => {
  describe('assertParamExists', () => {
    ...
    it('should throw RequiredError when parameter is null', () => {
      // Act & Assert
      expect(() => assertParamExists('testFunction', 'param1', null))
        .toThrow(RequiredError)
      expect(() => assertParamExists('testFunction', 'param1', null))
        .toThrow('Required parameter param1 was null or undefined when calling testFunction.')
    })

    it('should throw RequiredError when parameter is undefined', () => {
      // Act & Assert
      expect(() => assertParamExists('testFunction', 'param1', undefined))
        .toThrow(RequiredError)
      expect(() => assertParamExists('testFunction', 'param1', undefined))
        .toThrow('Required parameter param1 was null or undefined when calling testFunction.')
    })
