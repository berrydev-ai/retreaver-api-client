...
expect.extend({
  ...
  toBeValidAffiliate(received: any) {
    const pass = received && typeof received.afid === 'string';
  ...
  toBeValidTarget(received: any) {
    const pass = received && typeof received.id === 'number' && typeof received.number === 'string';
  ...
  toBeValidCampaign(received: any) {
    const pass = received && typeof received.cid === 'string' && typeof received.name === 'string';
