...
export const CallsV2ApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getCallByUuidV2: async (
      ...
      const localVarPath = `/api/v2/calls/{uuid}.json`.replace(
        `{${'uuid'}}`,
    ...
    getCallsV2: async (
      ...
      createdAtEnd?: string,
      sortBy?: GetCallsV2SortByEnum,
      order?: GetCallsV2OrderEnum,
      caller?: string,
      clientAfid?: string,
      clientCid?: string,
      clientTid?: string,
      subId?: string,
      callFlowEvents?: boolean,
      page?: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'apiKey' is not null or undefined
      ...
      if (createdAtStart !== undefined) {
        localVarQueryParameter['created_at_start'] =
          (createdAtStart as any) instanceof Date
            ? (createdAtStart as any).toISOString()
            : createdAtStart;
      }

      if (createdAtEnd !== undefined) {
        localVarQueryParameter['created_at_end'] =
          (createdAtEnd as any) instanceof Date
...
export const CallsV2ApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getCallByUuidV2(
      apiKey: string,
      uuid: string,
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CallV2Wrapper>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCallByUuidV2(
        apiKey,
        uuid,
        companyId,
        options
      ...
      const localVarOperationServerBasePath =
        operationServerMap['CallsV2Api.getCallByUuidV2']?.[localVarOperationServerIndex]?.url;
    ...
    async getCallsV2(
      ...
      page?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CallV2Wrapper>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCallsV2(
        apiKey,
        companyId,
        createdAtStart,
        createdAtEnd,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CallsV2Api.getCallsV2']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 */
export const CallsV2ApiFactory = function (
  ...
  return {
    ...
    getCallByUuidV2(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CallV2Wrapper> {
      return localVarFp
        .getCallByUuidV2(apiKey, uuid, companyId, options)
    ...
    getCallsV2(
      ...
      page?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<CallV2Wrapper>> {
      return localVarFp
        .getCallsV2(
          apiKey,
          companyId,
...
export class CallsV2Api extends BaseAPI {
   ...
   * @throws {RequiredError}
   */
  public getCallByUuidV2(
    apiKey: string,
    uuid: string,
    companyId?: number,
    options?: RawAxiosRequestConfig
  ) {
    return CallsV2ApiFp(this.configuration)
      .getCallByUuidV2(apiKey, uuid, companyId, options)
