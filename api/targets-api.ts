...
export const TargetsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteTarget: async (
      ...
      const localVarPath = `/targets/{id}.json`.replace(
        `{${'id'}}`,
    ...
    resetTargetCap: async (
      ...
      const localVarPath = `/targets/{id}/reset_cap.json`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TargetsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createTarget(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TargetWrapper>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.createTarget']?.[localVarOperationServerIndex]?.url;
    ...
    async deleteTarget(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.deleteTarget']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTargetById(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTargetById(
        apiKey,
        id,
        companyId,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.getTargetById']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTargets(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetWrapper>>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.getTargets']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async resetTargetCap(
      apiKey: string,
      id: number,
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.resetTargetCap(
        apiKey,
        id,
        companyId,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.resetTargetCap']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateTarget(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TargetsApi.updateTarget']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const TargetsApiFactory = function (
  ...
  return {
    ...
    createTarget(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<TargetWrapper> {
      return localVarFp
        .createTarget(apiKey, targetCreateRequest, companyId, options)
    ...
    deleteTarget(
      ...
      return localVarFp
        .deleteTarget(apiKey, id, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Retrieve a target by its internal ID.
    ...
    getTargetById(
      ...
      return localVarFp
        .getTargetById(apiKey, id, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Retrieve all destination phone numbers (targets) that calls can be routed to.
    ...
    getTargets(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<TargetWrapper>> {
      return localVarFp
        .getTargets(apiKey, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Clear calls contributing to the target\'s hard cap, resetting it to 0.
    ...
    resetTargetCap(
      ...
      return localVarFp
        .resetTargetCap(apiKey, id, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Update any attributes of an existing target.
    ...
    updateTarget(
      ...
      return localVarFp
        .updateTarget(apiKey, id, targetUpdateRequest, companyId, options)
        .then(request => request(axios, basePath));
    },
  };
};
