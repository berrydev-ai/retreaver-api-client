...
export const CampaignsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteCampaign: async (
      ...
      const localVarPath = `/campaigns/cid/{cid}.json`.replace(
        `{${'cid'}}`,
...
export const CampaignsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createCampaign(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CampaignWrapper>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['CampaignsApi.createCampaign']?.[localVarOperationServerIndex]?.url;
    ...
    async deleteCampaign(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CampaignsApi.deleteCampaign']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getCampaignByCid(
      apiKey: string,
      cid: string,
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CampaignWrapper>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCampaignByCid(
        apiKey,
        cid,
        companyId,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CampaignsApi.getCampaignByCid']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getCampaigns(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CampaignWrapper>>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CampaignsApi.getCampaigns']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateCampaign(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CampaignsApi.updateCampaign']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const CampaignsApiFactory = function (
  ...
  return {
    ...
    createCampaign(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CampaignWrapper> {
      return localVarFp
        .createCampaign(apiKey, campaignCreateRequest, companyId, options)
    ...
    deleteCampaign(
      ...
      return localVarFp
        .deleteCampaign(apiKey, cid, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Retrieve a campaign using your custom campaign ID.
    ...
    getCampaignByCid(
      ...
      return localVarFp
        .getCampaignByCid(apiKey, cid, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * List all campaigns with their routing settings and IVR configuration.
    ...
    getCampaigns(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<CampaignWrapper>> {
      return localVarFp
        .getCampaigns(apiKey, companyId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Update any attributes of an existing campaign.
    ...
    updateCampaign(
      ...
      return localVarFp
        .updateCampaign(apiKey, cid, campaignUpdateRequest, companyId, options)
        .then(request => request(axios, basePath));
    },
  };
};
