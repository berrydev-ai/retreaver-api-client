...
export const NumbersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getNumbers: async (apiKey: string, companyId?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const NumbersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getNumbers(apiKey: string, companyId?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NumberWrapper>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumbers(apiKey, companyId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NumbersApi.getNumbers']?.[localVarOperationServerIndex]?.url;
...
export const NumbersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getNumbers(apiKey: string, companyId?: number, options?: RawAxiosRequestConfig): AxiosPromise<Array<NumberWrapper>> {
            return localVarFp.getNumbers(apiKey, companyId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class NumbersApi extends BaseAPI {
    ...
    public getNumbers(apiKey: string, companyId?: number, options?: RawAxiosRequestConfig) {
        return NumbersApiFp(this.configuration).getNumbers(apiKey, companyId, options).then((request) => request(this.axios, this.basePath));
    }
}
