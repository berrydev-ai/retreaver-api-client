...
export const CallsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getCallByUuidV1: async (
      ...
      const localVarPath = `/calls/{uuid}.json`.replace(
        `{${'uuid'}}`,
    ...
    getCallsV1: async (
      ...
      createdAtEnd?: string,
      sortBy?: GetCallsV1SortByEnum,
      order?: GetCallsV1OrderEnum,
      caller?: string,
      clientAfid?: string,
      clientCid?: string,
      clientTid?: string,
...
export const CallsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getCallByUuidV1(
      apiKey: string,
      uuid: string,
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CallV1Wrapper>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCallByUuidV1(
        apiKey,
        uuid,
        companyId,
        options
      ...
      const localVarOperationServerBasePath =
        operationServerMap['CallsApi.getCallByUuidV1']?.[localVarOperationServerIndex]?.url;
    ...
    async getCallsV1(
      ...
      page?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CallV1Wrapper>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCallsV1(
        apiKey,
        companyId,
        createdAtStart,
        createdAtEnd,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CallsApi.getCallsV1']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const CallsApiFactory = function (
  ...
  return {
    ...
    getCallByUuidV1(
      ...
      companyId?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<CallV1Wrapper> {
      return localVarFp
        .getCallByUuidV1(apiKey, uuid, companyId, options)
    ...
    getCallsV1(
      ...
      page?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<CallV1Wrapper>> {
      return localVarFp
        .getCallsV1(
          apiKey,
          companyId,
